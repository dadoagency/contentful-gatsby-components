module.exports = {
  reviews: [
    {
      internal: {
        type: "ContentfulTrustpilotReviewB",
      },
              ...
              content: [
                {
                  nodeType: "text",
                  value:
                    "The joint formula has worked wonders for my old dog. He used to limp after going for walks, and now he runs around like he's ready to go again! Thanks Petlab!",
                  marks: [],
                  data: {},
                },
              ],
